...
Description: Showing your photostream from Dribbble, Flickr, Pinterest, Instagram
Author: Brankic1979
Version: 1.1
...
class BraPhotostreamWidget extends WP_Widget
{
	function BraPhotostreamWidget() {
		...
		'description' 	=>		'Showing your photostream from Dribbble, Flickr, Pinterest or Instagram'
		);
	...
	function widget( $args, $instance ) {
        ...
        wp_enqueue_script("bra_photostream", $root."bra_photostream_widget.js");
        wp_enqueue_style("bra_photostream", $root."bra_photostream_widget.css"); 
        
		$title = ( $instance['title'] ) ? $instance['title'] : 'Photostream';
		$user = ( $instance['user'] ) ? $instance['user'] : 'brankic1979';
        $social_network = ( $instance['social_network'] ) ? $instance['social_network'] : 'dribbble'; 
